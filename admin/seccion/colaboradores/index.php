<?php
include("../../bd.php");
$sentencia=$pdo->prepare("SELECT * FROM colaboradores;");
$sentencia->execute();
...
if(isset($_GET["txtID"])){
    ...
    $borrar=$pdo->prepare("DELETE FROM colaboradores WHERE id=:id");
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr class="">
                                    ...
                                    <td><?php echo $value["linkyoutube"];?></td>
